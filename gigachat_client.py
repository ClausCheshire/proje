...
async def evaluate_answer(question: str, user_answer: str, subject: str, exam_name: str) -> str:
    ...
    "• 0-20: Бред, не по теме, или только 'это правильно' без содержания → Итог: 1/5\n"
    "• 21-40: Есть 1-2 верные мысли, но нет аргументов и примеров → Итог: 2/5\n"
    "• 41-60: Ответ по теме, но поверхностный, аргументы слабые → Итог: 3/5\n"
    "• 61-80: Хороший ответ: есть структура, аргументы, минимальные ошибки → Итог: 4/5\n"
    "• 81-100: Отлично: глубина, точные ссылки, примеры, логика → Итог: 5/5\n"
    "\n"
    ...
    "6. Только ПОСЛЕ этого дай итоговый ответ с оценкой 1-5 и комментарием\n"
    "\n"
    "📝 ФОРМАТ ОТВЕТА (СТРОГО СОБЛЮДАТЬ):\n"
    "1. 📊 Оценка: X/5 (где X — число от 1 до 5, НИКАКИХ 100 баллов!)\n"
